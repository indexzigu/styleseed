...
[사용법](#사용법) · [왜-필요한가](#왜-필요한가) · [모션](#네임드-모션-시스템) · [AI-스킬-14개](#ai-스킬-14개) · [Wiki](../../wiki)
...
StyleSeed는 **디자인 엔진**입니다. 69개 시각 룰, 48개 컴포넌트, 네임드 모션 시스템, 14개 슬래시 커맨드가 LLM에게 데이터가 아니라 판단을 가르칩니다:
...
| **컴포넌트** | UI 프리미티브 33개 + 패턴 컴포넌트 |
| **모션** | 네임드 시드 5종 + 복사-붙여넣기 키워드 라이브러리 |
| **AI 스킬** | Claude Code 슬래시 명령어 14개 |
...
스킬을 복사하면 **슬래시 명령어 14개**를 쓸 수 있습니다 — 설정 · UI · 모션 · UX:
...
3. Claude에게: *"`skins/toss/theme.css`를 참고해서 [Linear / Apple / Material] 스타일 스킨 만들어줘"*
